...
import type { GetAllMembersParams } from '@/api-client/model';
...
export default function AdminPage({
  ...
  const { data: studentsData } = useGetAllMembers({
    query: {
      pageNo: 0,
      size: 100,
      criteria: 'name',
      search: studentSearchTerm,
    } satisfies GetAllMembersParams,
  });

  const filteredStudents = studentsData?.content || [];
